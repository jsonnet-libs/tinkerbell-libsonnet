---
permalink: /0.23/bmc/v1alpha1/task/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.task`](#obj-spectask)
    * [`fn withPowerAction(powerAction)`](#fn-spectaskwithpoweraction)
    * [`obj spec.task.bootDevice`](#obj-spectaskbootdevice)
      * [`fn withDevice(device)`](#fn-spectaskbootdevicewithdevice)
      * [`fn withEfiBoot(efiBoot)`](#fn-spectaskbootdevicewithefiboot)
      * [`fn withPersistent(persistent)`](#fn-spectaskbootdevicewithpersistent)
    * [`obj spec.task.oneTimeBootDeviceAction`](#obj-spectaskonetimebootdeviceaction)
      * [`fn withDevice(device)`](#fn-spectaskonetimebootdeviceactionwithdevice)
      * [`fn withDeviceMixin(device)`](#fn-spectaskonetimebootdeviceactionwithdevicemixin)
      * [`fn withEfiBoot(efiBoot)`](#fn-spectaskonetimebootdeviceactionwithefiboot)
    * [`obj spec.task.virtualMediaAction`](#obj-spectaskvirtualmediaaction)
      * [`fn withKind(kind)`](#fn-spectaskvirtualmediaactionwithkind)
      * [`fn withMediaURL(mediaURL)`](#fn-spectaskvirtualmediaactionwithmediaurl)
...
### fn spec.task.bootDevice.withEfiBoot
...
### fn spec.task.bootDevice.withPersistent
...
## obj spec.task.oneTimeBootDeviceAction
...
### fn spec.task.oneTimeBootDeviceAction.withDevice
...
### fn spec.task.oneTimeBootDeviceAction.withDeviceMixin
...
### fn spec.task.oneTimeBootDeviceAction.withEfiBoot
...
### fn spec.task.virtualMediaAction.withMediaURL
